...
public class QueryResultListTest {
	...
	public void setup() {
		...
		postingList1.addItem(new QueryResultItem(new PostingListItem(1, new int[]{3, 5},10,(short)10, (short)0),0, null));
		postingList1.addItem(new QueryResultItem(new PostingListItem(2, new int[]{4, 5},10,(short)10, (short)0),0, null));
		postingList1.addItem(new QueryResultItem(new PostingListItem(3, new int[]{3},10,(short)10, (short)0),0, null));

		postingList2 = new QueryResultList();
		postingList2.addItem(new QueryResultItem(new PostingListItem(1, new int[]{4, 5, 7},10,(short)10, (short)0),0, null));
		postingList2.addItem(new QueryResultItem(new PostingListItem(2, new int[]{3, 4},10,(short)10, (short)0),0, null));
		postingList2.addItem(new QueryResultItem(new PostingListItem(4, new int[]{3, 4, 5},10,(short)10, (short)0),0, null));
	}
	...
	public void testCombine() throws Exception {
		...
		expectedPostingList.addItem(new QueryResultItem(new PostingListItem(3, new int[]{3},10,(short)10, (short)0), 1*QueryResultList.MISSING_SCORE, null));
		expectedPostingList.addItem(new QueryResultItem(new PostingListItem(4, new int[]{3, 4, 5},10,(short)10, (short)0), 1*QueryResultList.MISSING_SCORE, null));
	...
	public void testCombinePhrase() throws Exception {
		...
		expectedPostingList.addItem(new QueryResultItem(new PostingListItem(1, new int[]{4},10,(short)10, (short)0),0, null));
